...
Your backend holds the API key, adds the organization-scoping header, and calls OpenFiskal on behalf of your locations and registers. Registers, browsers, and mobile apps should never call the API directly.
...
flowchart LR
    ...
    R2["Register 2"] --> B
    R3["Register 3"] --> B
    B -- "Bearer token + X-OpenFiskal-Organization" --> O["OpenFiskal API"]
```
