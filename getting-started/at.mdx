...
<Steps>
  <Step title="Create your API key">
    Generate an `aut` key at [console.openfiskal.com](https://console.openfiskal.com). Store it in your secrets manager. Format: `of_{env}_aut_{random}`, e.g. `of_test_aut_abcdefgh12345678`.
  </Step>
