  ...
  <Step title="Complete the operation">
    ...
    ```json
    {
      ...
      "fiscal_information": {
        ...
        "tss_serial_number": "c625d4b41c12f9229f39072c0d0adeb064ba35363c79c77dfd197d680dcd585d",
        "pos_client_serial_number": "ece21469-04b4-4140-be9b-d57b9f7efe28",
        ...
        "verification": {
          "qr_data": "V0;ece21469-04b4-4140-be9b-d57b9f7efe28;Kassenbeleg-V1;Beleg^42.50_0.00_0.00_0.00_0.00^42.50:Bar;113;4822;2026-02-25T19:02:11;2026-02-25T20:14:55;ecdsa-plain-SHA384;utcTime;base64encodedEndSignature==;base64encodedPublicKey=="
        }
      }
    }
    ```
...
A completed operation returns the data for the receipt under `fiscal_information`. The simplest compliant layout is to print your commercial fields (merchant, line items, amounts, and tax) plus the TSE data QR code.

`verification.qr_data` is a ready-to-print TSE data QR code string. Encode it to a QR code exactly as returned, byte for byte. It carries the full TSE data, including both serial numbers, so the TSE data QR code alone covers the TSE requirements.

<Warning>
  Print `pos_client_serial_number` as the cash-register serial if you print it as text. Do not use the register's `external_id`. That is your own identifier and is not signed into the TSE.
</Warning>

For the full list of required receipt fields, where each one comes from, and an example layout, see [German receipt requirements](/german-receipt-requirements).
