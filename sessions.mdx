...
- The **count** attests _what was actually in the drawer_ vs _what the system expected_. This is the variance attestation — the regulator's primary interest. Fiscally signed as a standalone event.
