...
<Info>
  The Hosted Receipts API uses the same server-to-server authentication model as the fiscalization API: `Authorization: Bearer ...` plus `X-OpenFiskal-Organization`.
</Info>
